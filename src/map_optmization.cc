...
bool MapOptmization::Init() {

}

bool MapOptmization::Proc() {
...
void MapOptmization::LaserCloudOutlierLastHandler(const sensor_msgs::PointCloud2ConstPtr &msg) {
...
void MapOptmization::LaserCloudCornerLastHandler(const sensor_msgs::PointCloud2ConstPtr &msg) {
...
void MapOptmization::LaserCloudSurfLastHandler(const sensor_msgs::PointCloud2ConstPtr &msg) {
...
void MapOptmization::LaserOdometryHandler(const nav_msgs::Odometry::ConstPtr &laserOdometry) {
...
void MapOptmization::ImuHandler(const sensor_msgs::Imu::ConstPtr &imuIn) {
  double roll, pitch, yaw;
...
void MapOptmization::TransformAssociateToMap() {
...
void MapOptmization::UpdateTransformPointCloudSinCos(PointTypePose *tIn){
  ctRoll = cos(tIn->roll);
  stRoll = sin(tIn->roll);
...
pcl::PointCloud<PointType>::Ptr MapOptmization::TransformPointCloud(pcl::PointCloud<PointType>::Ptr cloudIn) {
...
void MapOptmization::UpdatePointAssociateToMapSinCos() {
...
void MapOptmization::CornerOptimization(int iterCount) {
...
void MapOptmization::SurfOptimization(int iterCount) {
  updatePointAssociateToMapSinCos();
...
void MapOptmization::PublishKeyPosesAndFrames() {
...
void MapOptmization::ClearCloud() {
...
void MapOptmization::LoopClosureThread() {
  ...
  Timer timer;
  timer(PerformLoopClosure());
}

void MapOptmization::DetectLoopClosure() {
